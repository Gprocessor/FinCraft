...
const PAGES = {
  ...
  'treasury-dashboard': { mod: () => import('./pages/treasury.js'), label: 'Treasury Dashboard', icon: 'fa-gauge-high', view: 'dashboard', requiredPermission: 'READ_ACCOUNTTRANSFER' }, // same FinCraft-only permission-mapping caveat as the `treasury` route above
